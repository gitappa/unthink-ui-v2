          ...
          {isSwiftlyStyledInstance || isDoTheLookInstance ? (
            <div className="flex gap-1 items-center">
              {currentUser?.user_name ? (
                ...
                <>
                  ...
                  >
                    {currentUser?.user_name.length > 10
                      ? currentUser?.user_name.slice(0, 10) + "..."
                      : currentUser?.user_name}
                  </p>
                  <Image
                    src={userProfileIcon}
                ...
                >
                  <Text
                    ellipsis={true}
                    className="m-0 lg:text-base   font-bold leading-6 max-w-102 overflow-hidden overflow-ellipsis whitespace-nowrap product_name tracking-tighter-0.2"
                    style={{
                      color: themeCodes?.header?.textColor
                        ? themeCodes?.header?.textColor
                        : "#4F4F4F",
                    }}
                  >
                    Sign In
            ...
            <>
              {currentUser?.user_name ? (
                ...
                <Tooltip
                  title={currentUser?.user_name ? currentUser?.user_name : ""}
                  placement="top"
                >
                  <Image
                    src={userIcon}
                ...
                <>
                  ...
                  >
                    <button
                      ellipsis={true}
                      className="m-0 xl:text-base font-bold leading-6 max-w-102 overflow-hidden overflow-ellipsis whitespace-nowrap product_name tracking-tighter-0.2"
                      style={{
                        color: themeCodes?.header?.textColor
                          ? themeCodes?.header?.textColor
                          : "#4F4F4F",
