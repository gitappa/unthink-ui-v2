    ...
    >
      ...
      <div className="">
        ...
        <div className="flex flex-col gap-4 md:gap-6">
          <div
            className={`${fromCollection ? "" : "grid grid-cols-1 md:grid-cols-2"}  mt-2 lg:mt-3`}
          >
            {!fromCollection && (
            ...
            {qrCodeGeneratorURL &&
            (collection?.status === PUBLISHED || props.true) ? (
