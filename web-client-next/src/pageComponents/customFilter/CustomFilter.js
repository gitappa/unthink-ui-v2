		...
		<>
			{variant === "modal" ? (
				<div className="w-full">
					<label className="block text-[#4c5672] font-medium text-sm capitalize mb-1">
						{customFilterStoreData?.label ? customFilterStoreData.label.toLowerCase() : "hashtags"}
					</label>
					<Select
						mode='tags'
						className='w-full text-sm tag-select-input'
